...
public class ViewCustomer extends javax.swing.JFrame {
    ...
    private void viewAll() {
        ...
        try {
            ...
            while (DBconnect.rs.next()) {
                tableModel.addRow(new Object[]{DBconnect.rs.getString(1).toString(), DBconnect.rs.getString(2).toString(), DBconnect.rs.getString(3).toString(), DBconnect.rs.getString(4).toString(), DBconnect.rs.getString(5).toString()});
            }
        } catch (Exception ex) {
    ...
    private void setData() {
        ...
        c1.setAddress(txtAddress.getText());
        //c1.setTelephone(Integer.parseInt(txtTel.getText()));
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "View Customers", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Baskerville Old Face", 1, 24))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer ID", "Customer Name", "Address", "Telephone", "Entered Date"
            }
        ) {
        ...
        mnuAddNew.setText("Add new Customer");
        ...
        mnuSale.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.ALT_MASK));
        mnuSale.setText("Add new Sale");
        ...
        if (txtCustomerName.getText().equals("")) {
            ...
            if (txtTel.getText().length() < 10) {
                ...
                if (x == JOptionPane.YES_OPTION) {
                    c1.setTelephone(Math.abs(Integer.parseInt(txtTel.getText())));
                    sql = "UPDATE customer SET CustomerName= '" + c1.getCustomerName() + "',Address='" + c1.getAddress() + "',Telephone='" + c1.getTelephone() + "',EnteredDate='" + c1.getDate() + "' WHERE CustomerID='" + c1.getCustomerID() + "'";
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
            ...
            setData();
            sql = "SELECT * FROM sale WHERE CustomerID = '" + c1.getCustomerID() + "'";
            DBconnect.executeQ(sql);
            try {
                while (DBconnect.rs.next()) {
                    sl.setSaleID(DBconnect.rs.getString(1));
                }
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, ex.getMessage());
            }
            int x = JOptionPane.showConfirmDialog(this, "If you Delete this Customer the Customers past Sales data will be deleted Are You sure?", "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (x == JOptionPane.YES_OPTION) {
                String sql1 = "DELETE FROM purchase WHERE SaleID = '" + sl.getSaleID() + "'";
                DBconnect.updateQ(sql1);
                String sql2 = "DELETE FROM sale WHERE SaleID = '" + sl.getSaleID() + "'";
                DBconnect.updateQ(sql2);
                sql = "DELETE FROM customer WHERE CustomerID = '" + c1.getCustomerID() + "'";
    ...
    private void mnuAddNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuAddNewActionPerformed
        this.hide();
        AddNewCustomer l = new AddNewCustomer();
        l.setVisible(true);
